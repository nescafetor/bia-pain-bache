...
11. [تنظیمات Routing Rules](#تنظیمات-routings-rules)
...
حالا چطوری میشه تعدادشون رو اضافه کرد؟ توضیحات و تنظیمات بیشتر رو در بخش‌های [اضافه کردن IP تمیز](#7-4-تنظیمات-ip-تمیز) و [اضافه کردن پورت](#7.9-انتخاب-port) , [انتخاب پروتکل‌ها](#7.8-انتخاب-protocol) و [اضافه کردن Custom CDN](#7.6-تنظیمات-custom-cdn) توضیح دادیم. 
> [!CAUTION]
>برای استفاده از این ساب Mux رو از تنظیمات هر اپلیکیشنی که استفاده میکنید خاموش کنید.

> [!WARNING]
> با استفاده از این Worker مرتب IP دیوایس شما تغییر میکنه، بنابراین برای کارهایی مثل ترید و PayPal و حتی سایتهایی مثل Hetzner که حساس هستن ازش استفاده نکنید، امکان Ban شدن هست. در مورد فیکس کردن IP دو تا راه‌حل دادیم، یکی [تنظیم Proxy IP](#7.2-تنظیمات-proxy-ip) موقع راه‌اندازی و دومی [استفاده از Chain Proxy](#7.3-تنظیمات-chain-proxy).
<br><br>
...
این ساب کانفیگای بالایی رو میده با این تفاوت که تمام تنظیمات قست VLESS / Trojan پنل روش اعمال میشه که میتونید [اینجا](#7-تنظیمات-vlesstrojan) یاد بگیرید، همینطور این ساب‌ها کانفیگ **Best Ping** دارن (توضیح در ادامه). با اعمال تنظیمات routing تا حدود 90% تبلیغات ایرانی و خارجی رو بلاک میکنه، سایت‌های ایرانی و چینی رو دور میزنه (نیاز به خاموش کردن VPN برای درگاه پرداخت و ... نیست)، LAN رو دور میزنه، پورن و QUIC رو مسدود میکنه و همینطور ساب Sing-box محتواهای Phishing و Malware و ... رو تا حد خوبی مسدود میکنه.
> [!TIP]
...
> [!TIP]
> کانفیگ Best Fragment میاد 22 مقدار مختلف فرگمنت رو اعمال میکنه و هر کدوم سرعت بیشتری داشته باشن رو بر اساس اپراتور شما انتخاب مبکنه! این 18 حالت جوری انتخاب شده که هیچ بازه‌ای از قلم نیافته و کانفیگ تمام بازه‌های کوچیک و بزرگ رو هر 1 دقیقه تست کنه و به بهترینش وصل بشه. 
تنظیمات پیشرفته مربوط به فرگمنت هم [اینجا](#8-تنظیمات-fragment) توضیح داده شده.
<br><br>

#### 3.2 سابسکریپشن Fragment برای Hiddify
...
> 
> `https://doh/dns-query` مثل `https://dns.google/dns-query` , `https://dns.quad9.net/dns-query` , `https://doh.opendns.com/dns-query` ....
> 
...
<p align="center">
  <br><img src="https://github.com/NiREvil/bia-pain-bache/assets/126243832/3f23084b-fdf6-4b74-be80-bc31cee0c521" width="480px">
</p>
